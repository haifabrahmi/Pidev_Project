...
public class ConsulterReclamationAdminController implements Initializable {
  ...
  @Override
    ...
    try {
        int id = Integer.parseInt(idReclamationAdmin.getText());
        Reclamation reclamation = new Reclamation(id);
        ...
        alert.setContentText("L'état de la réclamation a été modifié avec succès !");
        alert.showAndWait();
    } catch (NumberFormatException e) {
        Alert alert = new Alert(AlertType.ERROR);
        alert.setTitle("Erreur de saisie");
        alert.setHeaderText(null);
        alert.setContentText("Veuillez saisir un identifiant de réclamation valide !");
        alert.showAndWait();
    } catch (Exception e) {
        Alert alert = new Alert(AlertType.ERROR);
    ...
    try {
        if (textReponse.getText().isEmpty()) {
            ...
            alert.setHeaderText(null);
            alert.setContentText("Veuillez remplir le champ de la réponse !");
            alert.showAndWait();
        } else {
        ...
        alert.setTitle("Erreur");
        alert.setHeaderText(null);
        alert.setContentText("Une erreur s'est produite lors de l'ajout de la réponse !");
        alert.showAndWait();
    }
});
    ...
    try {
        int id = Integer.parseInt(idReclamationAdmin.getText());
        Reclamation R1 = new Reclamation(id);
        CRUDReclamation rec = new CRUDReclamation();
        ...
        alert.setTitle("Erreur");
        alert.setHeaderText(null);
        alert.setContentText("Une erreur s'est produite lors de la suppression de la réclamation !");
        alert.showAndWait();
    }
});
    } 
