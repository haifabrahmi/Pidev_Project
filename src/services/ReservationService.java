...
public class ReservationService implements IService<Reservation> {
    ...
    public void ajouter(Reservation r) throws SQLException {
        String res = "INSERT INTO reservation (id_res,date_res, heure_res, type_ticket, prix, nb_place, prix_totale, imatriculation, id_usr) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        ps.setInt(8, r.getImatriculation());
        ps.setInt(9, r.getId_usr());
        ps.executeUpdate();
